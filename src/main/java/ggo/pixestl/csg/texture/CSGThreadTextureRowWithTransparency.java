	...
	public void run()
	{
        ...
        for (int x = 0; x < width-1; x++)
        {
            ...
            if (toBuildA) {
                ...
                polygonList.add(Polygon.fromPoints(triangleA1));
                ...
                polygonList.add(Polygon.fromPoints(triangleA2));
            }
            if (toBuildB) {
                ...
                polygonList.add(Polygon.fromPoints(triangleB1));
                ...
                polygonList.add(Polygon.fromPoints(triangleB2));
            }
            ...
            if (toBuildC) {
                ...
                polygonList.add(Polygon.fromPoints(triangleC1));
                ...
                polygonList.add(Polygon.fromPoints(triangleC2));
            }
            ...
            if (toBuildD) {
                ...
                polygonList.add(Polygon.fromPoints(triangleD1));
                ...
                polygonList.add(Polygon.fromPoints(triangleD2));
            }
